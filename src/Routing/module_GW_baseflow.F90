...
!------------------------------------------------------------------------------
   ...
   !use module_UDMAP, only: LNUMRSL, LUDRSL  !original
   use module_UDMAP, only: LNUMRSL, LUDRSL, subbasinID, q_sogw  !=====||___WHQ___||=====!
...
!DJG Implement subgrid weighting routine...
       ...
       q_sogw = runoff2x   ! flux from soil to gw bucket [mm] !=====||___WHQ___||=====!
...
!------------------------------------------------------------------------------
   ...
   use module_UDMAP, only: q_sogw  !=====||___WHQ___||=====!
