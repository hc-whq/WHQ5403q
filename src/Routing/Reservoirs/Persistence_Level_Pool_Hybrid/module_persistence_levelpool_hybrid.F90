...
contains
    ...
    subroutine run_hybrid_reservoir(this, previous_timestep_inflow, inflow, &
        ...
        !=====||___WHQ___||=====!  !LAKEFIX
        !
        !real                :: local_water_elevation    ! water elevation passed to levelpool (meters AMSL) !original
        real(kind=8)        :: local_water_elevation    ! water elevation passed to levelpool (meters AMSL)
        !   
        !=====||___WHQ___||=====!  !LAKEFIX
